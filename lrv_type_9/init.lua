    ...
    ["advtrains:lrv_type_9"] = {
        {
            ...
            base_textures = {
                ...
                "type_9_interior_walls.png",
                "type_9_wheels.png",
            },
            overlays = {
                [1] = {name = "Exterior Accents", slot_idx = 1, texture = "type_9_livery.png"},
                [2] = {name = "Side Doors",       slot_idx = 3, texture = "type_9_doors_livery.png"},
                [3] = {name = "Seats",            slot_idx = 4, texture = "type_9_seats_livery.png", alpha = 248},
            },
        },
    },
