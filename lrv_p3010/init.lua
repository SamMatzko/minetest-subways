...
local livery_template = {
    ...
    overlays = {
        [1] = {name = "Exterior Accents", slot_idx = 5, texture = "p3010_exterior_overlay.png", alpha = 255},
        [2] = {name = "Seat Accents", slot_idx = 3, texture = "p3010_seats_overlay.png", alpha = 255},
    }
}
...
if use_advtrains_livery_designer then
    ...
    local wagon_type = mod_name..":lrv_p3010"
...
advtrains.register_wagon(mod_name..":lrv_p3010", subway_wagon_def, "LRV P3010 (Subways)", "p3010_inv.png")

-- Crafting recipes
minetest.register_craft({
    output = mod_name..":lrv_p3010",
    recipe = {
